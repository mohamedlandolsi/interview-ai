...
const features = [
  ...
  {
    icon: BarChart3,
    title: "Comprehensive Results Analytics",
    description: "Access detailed transcripts, key metrics, insights, scoring, and hiring recommendations with advanced analysis tools.",
    highlights: ["Detailed transcripts", "Performance metrics", "AI insights", "Hiring recommendations"]
  },
  {
    icon: Settings,
    title: "Complete Settings Control",
    description: "Manage profiles, company information, integrations, and system configurations from a centralized settings hub.",
    highlights: ["Profile management", "Company settings", "API integrations", "System configuration"]
  },
  {
    icon: Bot,
    title: "Advanced AI Interviewer",
    description: "Powered by sophisticated AI that conducts natural conversations, asks follow-up questions, and adapts to candidate responses.",
    highlights: ["Natural conversation", "Adaptive questioning", "Real-time analysis", "Voice interaction"]
  },
  {
    icon: Users,
    title: "Multi-Role Support",
    description: "Designed for recruiters, HR professionals, candidates, and administrators with role-specific features and permissions.",
    highlights: ["Role-based access", "Permission control", "User management", "Admin oversight"]
  }
]
